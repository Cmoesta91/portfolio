...
namespace SGBank.BLL
{
    public class AccountManager
    {
        ...
        public AccountDepositResponse Deposit(string accountNumber, decimal amount)
        {
            ...
            IDeposit depositRule = DepositRulesFactory.Create(response.Account.accountType);
        ...
        public AccountWithdrawResponse Withdraw(string accountNumber, decimal amount)
        {
            ...
            IWithdraw withdrawRule = WithdrawRulesFactory.Create(response.Account.accountType);
